...
type LocalStorageArrayItem<K extends LocalStorageArrayKey> = LocalStorageValueMap[K] extends readonly (infer T)[] ? T : never;
...
export class LocalStorageManager {
    ...
    static appendToArrayItem<K extends LocalStorageArrayKey>(key: K, value: LocalStorageArrayItem<K>): void {
